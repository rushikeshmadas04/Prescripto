...
const AllAppointments = () => {
 ...
 text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll' >
        ...
        {appointments.map((item, index) => (
          <div className='flex flex-wrap justify-between items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-100 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] gap-2' key={index}>
